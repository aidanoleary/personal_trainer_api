...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { description: @achievement.description, image_url: @achievement.image_url, name: @achievement.name }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { description: @achievement.description, image_url: @achievement.image_url, name: @achievement.name }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
