...
class UserWorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create user_workout" do
    assert_difference('UserWorkout.count') do
      post :create, user_workout: { time_taken: @user_workout.time_taken, user_id: @user_workout.user_id, workout_date: @user_workout.workout_date, workout_id: @user_workout.workout_id }
    end
  ...
  test "should update user_workout" do
    patch :update, id: @user_workout, user_workout: { time_taken: @user_workout.time_taken, user_id: @user_workout.user_id, workout_date: @user_workout.workout_date, workout_id: @user_workout.workout_id }
    assert_redirected_to user_workout_path(assigns(:user_workout))
  end
